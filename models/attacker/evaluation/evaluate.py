...
from models.attacker.evaluation.evaluators import evaluate_to_plot_2d, evaluate_to_plot_3d, visual_evaluation
...
if __name__ == "__main__":
    ...
    visual_eval_env = Monitor(QuadXHoverAgiliciousAttEnv(
        sparse_reward=False, 
        fixed_hover_position=EVAL_HOVER_POINT,
    ...
    # Load models
    attacker_model = PPO.load(MODEL_PATH, env=eval_env)
    ...
    evaluate_to_plot_2d(
        nominal_model, attacker_model, eval_env, 
    ...
    print('Hover point:', EVAL_HOVER_POINT)
    evaluate_to_plot_3d(nominal_model, attacker_model, eval_env, hover_point=EVAL_HOVER_POINT, plot_path=PLOT_SAVE_PATH)
    print('Plots saved in:', PLOT_SAVE_PATH)
    ...
    if VISUAL_EVAL:
        ...
        visual_evaluation(nominal_model, attacker_model, visual_eval_env, n_eval_episodes=2)
