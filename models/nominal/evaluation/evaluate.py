...
from models.nominal.evaluation.evaluators import evaluate_to_plot_2d, evaluate_to_plot_3d, visual_evaluation
...
if __name__ == "__main__":
    ...
    visual_eval_env = Monitor(QuadXHoverAgiliciousNomEnv(
        sparse_reward=False, 
        fixed_hover_position=EVAL_HOVER_POINT,
    ...
    evaluate_to_plot_2d(model, eval_env, n_eval_episodes=N_EVAL_EPISODES, hover_point=EVAL_HOVER_POINT, plot_path=PLOT_SAVE_PATH)
    ...
    print('Hover point:', EVAL_HOVER_POINT)
    evaluate_to_plot_3d(model, eval_env, hover_point=EVAL_HOVER_POINT, plot_path=PLOT_SAVE_PATH)
    print('Plots saved in:', PLOT_SAVE_PATH)
    ...
    if VISUAL_EVAL:
        ...
        print('Hover point:', EVAL_HOVER_POINT)
        model.env = visual_eval_env
        visual_evaluation(model, visual_eval_env, n_eval_episodes=2)
